    ...
    return (
        <header className="font-sans ">
            <nav className="flex flex-row justify-between bg-white border-b-4 border-green-400">
                <div className="flex">
                    <a href="/" className="flex flex-row items-center me-10">
            <img className="w-1/6 ms-10" src="https://res.cloudinary.com/drvtrcm96/image/upload/v1740906337/grammarly_logo_mefgjy.webp" alt="Grammarly Logo" />
                    </a>
